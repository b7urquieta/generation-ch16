...
-- -----------------------------------------------------
-- Table `ejemplo_producto`.`PRODUCTO_has_PROVEDOR`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ejemplo_producto`.`PRODUCTO_has_PROVEDOR` ;

CREATE TABLE IF NOT EXISTS `ejemplo_producto`.`PRODUCTO_has_PROVEDOR` (
  `PRODUCTO_codigo` INT NOT NULL,
  `PROVEDOR_nif` INT NOT NULL,
  PRIMARY KEY (`PRODUCTO_codigo`, `PROVEDOR_nif`),
  INDEX `fk_PRODUCTO_has_PROVEDOR_PROVEDOR1_idx` (`PROVEDOR_nif` ASC) VISIBLE,
  INDEX `fk_PRODUCTO_has_PROVEDOR_PRODUCTO1_idx` (`PRODUCTO_codigo` ASC) VISIBLE,
  CONSTRAINT `fk_PRODUCTO_has_PROVEDOR_PRODUCTO1`
    FOREIGN KEY (`PRODUCTO_codigo`)
    REFERENCES `ejemplo_producto`.`PRODUCTO` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_PRODUCTO_has_PROVEDOR_PROVEDOR1`
